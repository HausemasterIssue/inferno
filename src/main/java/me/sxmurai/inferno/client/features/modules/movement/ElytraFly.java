...
public class ElytraFly extends Module {
    ...
    public final Value<Float> speed = new Value<>("Speed", 2.5f, 0.1f, 5.0f);
    public final Value<Float> speedLimit = new Value<>("SpeedLimit", 180.0f, 1.0f, 250.0f);
    public final Value<Boolean> takeOff = new Value<>("TakeOff", true);
    public final Value<Float> takeOffTimerAmount = new Value<>("TakeOffTimer", 0.1f, 0.1f, 1.0f, (v) -> takeOff.getValue());
    public final Value<Up> up = new Value<>("GoUp", Up.MOTION);
    public final Value<Float> fireworkDelay = new Value<>("FireworkDelay", 2.0f, 1.0f, 5.0f, (v) -> this.up.getValue() == Up.FIREWORK);
    public final Value<Boolean> infinite = new Value<>("InfiniteElytra", false);
    public final Value<Boolean> sounds = new Value<>("Sounds", true);
